...
3. Choose the folder with the "Static_Data_Synchronisation" name.

4. Import the static_data_synchronisation.ipynb sample file into your Google Drive.
